...
begin
  ...
  try
    ...
    if edtCodigo.Checked then
      qry.SQL.Add(' where p.cd_produto ilike ' + QuotedStr('%'+edtPesquisa.Text+'%'));
    ...
    begin
      ...
      cdsConsultaProduto.FieldByName('cd_produto').AsString := qry.FieldByName('cd_produto').AsString;
      ...
      cdsConsultaProduto.FieldByName('id_item').AsLargeInt := qry.FieldByName('id_item').AsLargeInt;
